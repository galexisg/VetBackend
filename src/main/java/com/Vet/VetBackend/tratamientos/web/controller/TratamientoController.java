...
public class TratamientoController {
    ...
    @GetMapping public List<TratamientoRes> listar() { return service.listar(); }
    @GetMapping("/{id}") public TratamientoRes obtener(@PathVariable Long id) { return service.obtenerPorId(id); }
